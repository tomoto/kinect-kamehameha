...
# OpenNI 2.0 installer end

# Try to reload the new rules
...
# Prompt
echo Now the installation is complete. You may need to restart the computer to make the sensor available.
